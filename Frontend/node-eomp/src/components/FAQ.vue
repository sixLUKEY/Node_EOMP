<template>
    <div class="flex flex-col gap-6 my-12">
        <h2 class="text-3xl relative w-fit ">
            Frequently asked questions
        </h2>

        <div class="flex items-center gap-5 w-full border-primary border p-2 rounded-sm">
            <span class="text-5xl text-primary">Q</span>
            <select name="faq" id="faq" class="text-2xl flex-1 text-center" v-model="selected">
                <option value="Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur aspernatur expedita, odit consequatur culpa quas impedit odio labore, nihil, similique veniam cumque qui. Dolores iusto ipsa nemo eos ea minus?">What is lorem ipsum?</option>
                <option value="The quick brown fox jumped over the lazy dog">What is logo ipsum?</option>
            </select>
        </div>

        <div class="w-full border border-primary flex p-2 items-center gap-5 rounded-sm">
